...
struct equal_ckey_ckey:
  mp11::mp_if_c<
    is_same<KeyCons1,tuples::null_type>::value||
    is_same<KeyCons2,tuples::null_type>::value,
...
struct equal_ckey_cval:
  mp11::mp_if_c<
    is_same<KeyCons,tuples::null_type>::value||
    is_same<ValCons,tuples::null_type>::value,
